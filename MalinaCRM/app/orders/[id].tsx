...
export default function OrderDetailsScreen() {
  ...
  useEffect(() => {
    ...
    setKidsCount(o.kidsCount === null || o.kidsCount === undefined ? "" : String(o.kidsCount));
    setKidsAge(o.kidsAge ?? "");
    setBirthdayName(o.birthdayName ?? "");
    setAddress(o.address ?? "");
    setPriceTotal(o.priceTotal === null || o.priceTotal === undefined ? "" : String(o.priceTotal));
    setPrepayment(o.prepayment === null || o.prepayment === undefined ? "" : String(o.prepayment));
